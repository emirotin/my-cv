...
import CHAR_MAPPING from "../src/lcd-font/charmap.json" assert { type: "json" };
import CONFIG from "../src/lcd-font/config.json" assert { type: "json" };
...
export const getFilePath = (...fileNames) => {
  return path.resolve(getDirname(), ...fileNames);
};

const PNG_FILE = getFilePath("..", "src", "lcd-font", "alphabet.png");
const OUT_FILE = getFilePath("..", "src", "lcd-font", "alphabet.json");
